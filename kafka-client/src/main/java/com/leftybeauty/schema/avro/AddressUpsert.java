...
public class AddressUpsert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageDecoder<AddressUpsert> DECODER =
      new BinaryMessageDecoder<AddressUpsert>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AddressUpsert> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AddressUpsert> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AddressUpsert> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AddressUpsert>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AddressUpsert to a ByteBuffer.
  ...
  /**
   * Deserializes a AddressUpsert from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AddressUpsert instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AddressUpsert fromByteBuffer(
   ...
   */
  public AddressUpsert(java.lang.CharSequence addressId, java.lang.CharSequence leftyUserId, java.lang.CharSequence street1, java.lang.CharSequence street2, java.lang.CharSequence city, com.leftybeauty.schema.avro.UsStateEnum state, java.lang.Integer zipCode) {
  ...
  /**
   * Creates a new AddressUpsert RecordBuilder.
   * @return A new AddressUpsert RecordBuilder
   */
  public static com.leftybeauty.schema.avro.AddressUpsert.Builder newBuilder() {
    return new com.leftybeauty.schema.avro.AddressUpsert.Builder();
  }

  /**
   * Creates a new AddressUpsert RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AddressUpsert RecordBuilder
   */
  public static com.leftybeauty.schema.avro.AddressUpsert.Builder newBuilder(com.leftybeauty.schema.avro.AddressUpsert.Builder other) {
    if (other == null) {
      return new com.leftybeauty.schema.avro.AddressUpsert.Builder();
    } else {
      return new com.leftybeauty.schema.avro.AddressUpsert.Builder(other);
    }
  }

  /**
   * Creates a new AddressUpsert RecordBuilder by copying an existing AddressUpsert instance.
   * @param other The existing instance to copy.
   * @return A new AddressUpsert RecordBuilder
   */
  public static com.leftybeauty.schema.avro.AddressUpsert.Builder newBuilder(com.leftybeauty.schema.avro.AddressUpsert other) {
    if (other == null) {
      return new com.leftybeauty.schema.avro.AddressUpsert.Builder();
    } else {
      return new com.leftybeauty.schema.avro.AddressUpsert.Builder(other);
  ...
  /**
   * RecordBuilder for AddressUpsert instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AddressUpsert>
    implements org.apache.avro.data.RecordBuilder<AddressUpsert> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.leftybeauty.schema.avro.AddressUpsert.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AddressUpsert instance
     * @param other The existing instance to copy.
     */
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setAddressId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearAddressId() {
      addressId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setLeftyUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearLeftyUserId() {
      leftyUserId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setStreet1(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearStreet1() {
      street1 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setStreet2(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearStreet2() {
      street2 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setState(com.leftybeauty.schema.avro.UsStateEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder setZipCode(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.leftybeauty.schema.avro.AddressUpsert.Builder clearZipCode() {
    ...
    public AddressUpsert build() {
      try {
        AddressUpsert record = new AddressUpsert();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AddressUpsert>
    WRITER$ = (org.apache.avro.io.DatumWriter<AddressUpsert>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AddressUpsert>
    READER$ = (org.apache.avro.io.DatumReader<AddressUpsert>)MODEL$.createDatumReader(SCHEMA$);
